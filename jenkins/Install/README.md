...
```
cd /tmp ; sudo wget https://dlcdn.apache.org/maven/maven-3/3.9.0/binaries/apache-maven-3.9.0-bin.tar.gz
...
```
sudo echo "MAVEN_HOME=\"/opt/apache-maven-3.9.0\"" >> /etc/profile
